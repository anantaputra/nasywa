...
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed flex justify-center mt-20 z-50 w-full md:inset-0 h-modal md:h-full">
