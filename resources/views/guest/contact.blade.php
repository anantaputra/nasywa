...
<div class="w-full px-16 py-8">
    {{-- <div class="w-full h-96 bg-red-300">
        <p class="text-2xl text-white mb-4">Temukan kami di</p>
    ...
    <div class="grid grid-cols-2 space-x-16 px-32">
        <div>
            <p class="text-5xl font-bold text-red-300 mb-4" style="font-family: 'Nunito', sans-serif;">Hubungi kami</p>
            ...
            <form action="" method="post" class="space-y-8">
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" name="name" id="name" class="w-full bg-gray-200 px-4 py-4 text-sm border border-gray-200 rounded-full" placeholder="Nama Anda">
                </div>
                <div class="flex flex-col space-y-2">
                    <label for="email" class="text-lg font-semibold text-gray-600">Email Anda</label>
                    <input type="text" name="email" id="email" class="w-full bg-gray-200 px-4 py-4 text-sm border border-gray-200 rounded-full" placeholder="Email Anda">
                </div>
                <div class="flex flex-col space-y-2">
                    <label for="message" class="text-lg font-semibold text-gray-600">Pesan Anda</label>
                    <textarea name="message" id="message" cols="30" rows="10" class="w-full px-4 py-4 text-sm bg-gray-200 border border-gray-200 rounded-2xl"></textarea>
                </div>
                <button class="bg-red-300 text-xl shadow-lg text-white font-medium rounded-full py-4 px-16 hover:bg-red-400">Kirim Pesan</button>
            </form>
        </div>
        <div>
            <div class="py-16">                
